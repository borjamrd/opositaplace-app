        ...
        <div className="flex flex-col min-h-screen">
            ...
            <section className="py-20 md:py-32 bg-gradient-to-br from-primary/10 via-background to-secondary/20">
                <div className="container mx-auto px-4 text-center">
                    <h1 className="text-4xl md:text-6xl font-extrabold tracking-tight mb-6">
                        <span className="text-primary">Opositaplace.</span> Por opositores. Para
                        opositores.
                    </h1>
                    <p className="text-lg md:text-xl text-foreground/80 max-w-3xl mx-auto mb-10">
                        Organiza tu estudio, sigue tu progreso y alcanza tus metas con nuestra
                        plataforma integral diseñada para opositores como tú.
                    </p>
            ...
            <section id="features" className="py-20 md:py-28 bg-secondary/30">
                <div className="container mx-auto px-4">
                    ...
                    <p className="text-center text-foreground/70 max-w-2xl mx-auto mb-16 text-lg">
                        Descubre las herramientas que te ayudarán a optimizar tu preparación y
                        conseguir tu plaza.
                    </p>
            ...
            <footer className="py-8 bg-primary/5 border-t border-border/20">
                <div className="container mx-auto px-4 text-center text-foreground/60">
                    <p>
                        &copy; {new Date().getFullYear()} OpositaPlace. Todos los derechos
                        reservados.
                    </p>
                    <p className="text-sm mt-2">
                        Hecho con <span className="text-red-500">❤️</span> para los futuros
                        funcionarios.
                    </p>
                </div>
            </footer>
